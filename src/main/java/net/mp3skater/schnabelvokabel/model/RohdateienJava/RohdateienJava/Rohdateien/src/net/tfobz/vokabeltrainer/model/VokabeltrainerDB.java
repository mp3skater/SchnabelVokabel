...
//										"    fnummer = " + fach.getNummer() + ";";
  ...
  public static int exportierenKarten(int nummerLernkartei, String pfad, boolean mitFaechern) {
	...
	public static void printDB() {
		for (Lernkartei kartei : getLernkarteien()) {
			System.out.println("Kartei: " + kartei.getBeschreibung());
			for (Fach fach : getFaecher(kartei.getNummer())) {
				System.out.println("Fach: " + fach.getBeschreibung());
				System.out.println();
				for (Karte karte : getKarten(fach.getNummer())) {
