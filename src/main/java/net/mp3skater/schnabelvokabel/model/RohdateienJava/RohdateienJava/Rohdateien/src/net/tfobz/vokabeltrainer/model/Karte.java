...
/**
 * Stellt eine Karte dar, welche zwei W�rter, eine Abfragerichtung und die
 * Information ob beim Vergleichen der W�rter die Gro�-/Kleinschreibung
 * ber�cksichtigt werden soll, enth�lt. Bei einer Karte m�ssen die beiden W�rter
...
public class Karte {
	...
	public boolean equals(Object o) {
		...
		if (o != null && o instanceof Karte) {
			Karte k = (Karte) o;
			if (k.nummer == nummer && (k.wortEins == null && wortEins == null || k.wortEins.equals(wortEins))
	...
	/**
	 * Liefert in Abh�ngigkeit der eingestellten Fragerichtung und in Abh�ngigkeit
	 * ob die Gro�-/Kleinschreibung ber�cksichtigt werden soll ob das eingegebene
	 * Wort dem gesuchten Wort entspricht
	 * 
	 * @param wort
	 * @return
	 */
	...
	public void setCapitalization(boolean cap) {
		this.grossKleinschreibung = cap;
	}
